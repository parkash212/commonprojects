...
@Test
public class Evolvelove {	
	//@BeforeClass
//ExtentReports reports = new ExtentReports(System.getProperty("user.dir") + "\\ExtentReportsResults.html");
...
// for login
//driver.findElement(By.name("email")).sendKeys("jennifer@jennifersrussell.com");
...
/*	try {
	...
	FileReader reader=new FileReader("Arabic-TVFH website translation - 16 May.docx");
	props.load(reader); }
	catch ( Exception e) {
		System.out.println(e);
	}
	div[@class='control-group']//input[@placeholder='Email'] */
...
// for login
//	driver.findElement(By.name("email")).sendKeys("jennifer@jennifersrussell.com");
//driver.findElement(By.name("email")).sendKeys("11111111");
//driver.findElement(By.name("email")).sendKeys("jennifer@jennifersrussell.com");
//	logger = LogManager.getLogger(this.getClass());
//@Test
   driver.findElement(By.xpath("//a[@class='nav-link active']")).click();
  // driver.findElement(By.xpath(" //a[normalize-space()='START QUIZ']")).click();//a[@class='btn btn-white mt-3']
   Thread.sleep(2000);
   
   WebElement thirdnext = driver.findElement(By.xpath("//a[@class='btn btn-white mt-3']"));
   js.executeScript("arguments[0].click();",thirdnext);
...
// qustion - 9 
 ...
 // question = 19
  ...
  js.executeScript("arguments[0].value='parkash.sharma@imarkinfotech.com';", clicking5);
  ...
  // qustion = 23
 try {
	  WebElement clicking6 = driver.findElement(By.xpath("//input[@name='question23']"));
  js.executeScript("arguments[0].value='9999999';", clicking6);
 ...
 //js.executeScript("arguments[0].click();", button26);
  ...
  // free report
  try {
 // WebElement button27= driver.findElement(By.xpath("//a[@class = 'btn btn-primary br']"));
...
WebElement reports = driver.findElement(By.xpath("//a[@class='btn btn-white br w-100' and text() ='GET MY FULL REPORT']"));
...
Thread.sleep(2000);
  ...
  try {
  driver.findElement(By.xpath("//input[@name='address']']")).sendKeys("new");
  driver.findElement(By.xpath("//input[@name='city']")).sendKeys("aussy");
  driver.findElement(By.xpath("//input[@name='state']']")).sendKeys("hry");
  driver.findElement(By.xpath("//input[@name='zipcode']")).sendKeys("86585");
  } catch(Exception e) {
	  System.out.println(e);
  }
  
  //payment card
  driver.findElement(By.xpath("//input[@name='number']")).sendKeys("4242424242424242");
  driver.findElement(By.xpath("//input[@name='expiry']")).sendKeys("1225");
//Alert alertwindow = driver.switchTo().alert();	
 //  alertwindow.dismiss();
  // sign in

  /*WebElement names = driver.findElement(By.xpath("//div[@class='control-group mb-4']//input[@type='email']"));//email
  js.executeScript("arguments[0].value='jennifer@jennifersrussell.com';",names);
 

  WebElement passcode = driver.findElement(By.id("password")); // password
