...
public class upgradeevolvelove {	
	//@BeforeClass
...
//	logger = LogManager.getLogger(this.getClass());
  ...
  js.executeScript("arguments[0].click();",button1 );
   ...
   driver.findElement(By.xpath("//span[normalize-space()='Yes']")).click();  // 2nd question  // //label[1]
   WebElement button2 = driver.findElement(By.xpath(" //a[@id='next1']")); 
   js.executeScript("arguments[0].click();",button2 );
   
   driver.findElement(By.xpath("//span[normalize-space()='Romantic partner']")).click(); // 3rd qus
   WebElement button3 = driver.findElement(By.xpath(" //a[@id='next1']"));
   js.executeScript("arguments[0].click();",button3 );
   
   driver.findElement(By.name("question4")).sendKeys("ash");  // 4th qustion
...
// qustion - 9 
 ...
 // qustion = 19
  ...
  try {
	  ...
	  WebElement button25 =driver.findElement(By.xpath("//input[@name='phone_concent']"));
